...
function FooterLinks() {
  return (
    <div className='footer-links-style'>
      ...
      <div className='imdb-footer-links'>

        <div className='footer-logos'>
            {/* <ul style={{display:"flex"}}> */}
                <NavLink title='TikTok' className='logo-container'>
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" class="ipc-icon ipc-icon--tiktok" viewBox="0 0 24 24" fill="white" role="presentation">
                ...
                <NavLink title='Instagram' className='logo-container'>
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" class="ipc-icon ipc-icon--instagram" viewBox="0 0 24 24" fill="white" role="presentation">
                ...
                <NavLink title='Twitter' className='logo-container'>
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" class="ipc-icon ipc-icon--twitter" viewBox="0 0 24 24" fill="white" role="presentation">
                ...
                <NavLink title='YouTube' className='logo-container'>
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" class="ipc-icon ipc-icon--youtube" viewBox="0 0 24 24" fill="white" role="presentation">
                ...
                <NavLink title='Facebook' className='logo-container'>
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" class="ipc-icon ipc-icon--facebook" viewBox="0 0 24 24" fill="white" role="presentation">
