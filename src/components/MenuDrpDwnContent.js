...
function MenuDrpDwnContent() {
  return (
    <div>
      <div>
        <span style={{color: "rgb(245,197,24)",opacity: "1",marginTop:"5px"}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="ipc-icon-movie" viewBox="0 0 24 24" fill="currentColor" role="presentation">
...
export default MenuDrpDwnContent
